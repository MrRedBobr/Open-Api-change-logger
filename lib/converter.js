...
var Converter = /** @class */ (function () {
    function Converter(diffs, config) {
        this._changeLog = diffs;
        this._config = config;
    }
    Converter.prototype.fixedName = function (field) {
        return field.replace('__added', '').replace('__deleted', '');
    };
    Converter.prototype.changeTypeFromName = function (field) {
        return field.includes('__deleted') || field.includes('__added') ? (field.includes('__deleted') ? 'Deleted' : 'Added') : '';
    };
    Converter.prototype.getSchemaObjectType = function (schema) {
        var _a, _b, _c, _d;
    ...
    Converter.prototype.renderSchemas = function () {
        var _this = this;
    ...
    Converter.prototype.renderSchema = function (changeType, type, name, fixedName, schema, diffSchema) {
        var _a, _b;
    ...
    Converter.prototype.renderProperties = function (destinationSchemaProperties, diffProperties, sourceSchemaProperties) {
        var e_1, _a;
        var _this = this;
    ...
    Converter.prototype.pathChanges = function (_a) {
        var _b, _c, _d, _e;
    ...
    Converter.prototype.getPathRenderer = function () {
        var _this = this;
    ...
    Converter.prototype.renderParameters = function (parameters, diffParameters) {
        var e_2, _a;
        var _b, _c, _d;
        var params = {};
        try {
    ...
    Converter.prototype.changes = function () {
        var _a = this._config, hbsTemplate = _a.hbsTemplate, apiName = _a.apiName, other = __rest(_a, ["hbsTemplate", "apiName"]);
        return __assign({ schemas: this.renderSchemas(), paths: this.getPathRenderer(), name: apiName, version: this._changeLog.version }, other);
    };
    return Converter;
}());
