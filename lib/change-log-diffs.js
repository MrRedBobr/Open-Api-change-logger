...
exports.ChangeLogDiffs = void 0;
var json_diff_1 = __importDefault(require("json-diff"));
var ChangeLogDiffs = /** @class */ (function () {
    function ChangeLogDiffs(source, destination) {
        this._schemasNames = [];
    ...
    Object.defineProperty(ChangeLogDiffs.prototype, "apiObjectDiffs", {
        get: function () {
    ...
    Object.defineProperty(ChangeLogDiffs.prototype, "source", {
        get: function () {
            return this._source;
        },
        enumerable: false,
    ...
    Object.defineProperty(ChangeLogDiffs.prototype, "destination", {
        get: function () {
    ...
    Object.defineProperty(ChangeLogDiffs.prototype, "schemasNames", {
        get: function () {
    ...
    Object.defineProperty(ChangeLogDiffs.prototype, "paths", {
        get: function () {
            return this._paths;
        },
        enumerable: false,
    ...
    Object.defineProperty(ChangeLogDiffs.prototype, "version", {
        get: function () {
    ...
    ChangeLogDiffs.prototype.apiDifference = function () {
        this._apiObjectDiffs = json_diff_1.default.diff(this._source, this._destination);
    };
    ChangeLogDiffs.prototype.pathsAndSchemasName = function () {
        var _a, _b;
        var _c, _d;
    ...
    ChangeLogDiffs.prototype.changes = function () {
    ...
    ChangeLogDiffs.prototype.apiVersionByChanges = function () {
        if (this.hasChanges()) {
    ...
    ChangeLogDiffs.prototype.hasChanges = function () {
        return this._hasPathsChanges || this._hasSchemasChanges;
    };
    return ChangeLogDiffs;
}());
exports.ChangeLogDiffs = ChangeLogDiffs;
//# sourceMappingURL=change-log-diffs.js.map